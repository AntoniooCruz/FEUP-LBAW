...
insert into users (username, email, name, password, description, active, user_type) values ('ghymor6', 'ghymor6@umich.edu', 'Gideon Hymor', '5ZHM8CPjR', 'placerat ante nulla justo aliquam quis turpis eget elit sodales', true, 'Personal');

<div class="progress roundRadius" >
        ...
        <div id={{$pollOption->id_poll_option}} class="progress-bar bg-info" role="progressbar" style="{{ 'width:'.floor(sizeof($pollOption->votesOnPollOption()->get())/sizeof($pollOption->poll->votesOnPoll()->get())*100).'%;'}}"" aria-valuenow="25"
